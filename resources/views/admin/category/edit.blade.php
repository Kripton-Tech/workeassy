...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.category.update') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <textarea name="discription" id="discription" class="form-control" placeholder="Plese enter discription">{{ $data->discription ?? '' }}</textarea>
