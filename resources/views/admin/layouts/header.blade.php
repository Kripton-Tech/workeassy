        ...
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand">
                <a href="{{ route('admin.dashboard') }}">
                    <b class="logo-icon">
                        <!-- <img src="{{ _small_logo() }}" alt="home" class="dark-logo" style="max-width: 45px; max-height: 45px;" /> -->
                        <!-- <img src="{{ _small_logo() }}" alt="home" class="light-logo" style="max-width: 45px; max-height: 45px;" /> -->
                    </b>
                    <span class="logo-text">
                        <img src="{{ _logo() }}" alt="home" class="dark-logo" style="max-width: 200px; max-height: 45px;" />
                        <img src="{{ _logo() }}" alt="home" class="light-logo" style="max-width: 200px; max-height: 45px;" />
                    </span>
                </a>
            </div>
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{ asset('uploads/users').'/'.auth()->user()->photo }}" alt="user" class="rounded-circle" width="40">
