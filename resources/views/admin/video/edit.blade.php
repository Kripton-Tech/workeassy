...
<div class="container-fluid">
    <div class="row main">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('admin.video.update') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="row m-2">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="text" name="link" id="link" class="form-control" placeholder="Plese enter link" value="{{ @old('link', $data->link) }}">
