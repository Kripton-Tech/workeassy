    ...
    <div class="row">
        ...
        <div class="col-5 align-self-center">
            <div class="customize-input float-right">
                <a href="{{ route('admin.workspace.create') }}" class="btn waves-effect waves-light btn-rounded btn-outline-primary mb-3 ml-3">Add</a>
            </div>
        </div>
    </div>
</div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function change_status(object){
            ...
            if (confirm(msg)) {
                $.ajax({
                    "url": "{!! route('admin.workspace.change.status') !!}",
                    "dataType": "json",
                    "type": "POST",
                    "data":{
                        id: id,
