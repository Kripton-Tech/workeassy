...
<div class="container-fluid">
    <div class="row main">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('admin.workspace.update') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="row m-2">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input type="text" name="sub_title" id="sub_title" class="form-control" placeholder="Plese enter sub title" value="{{ @old('sub_title', $data->sub_title) }}">
