            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.about') }}" class="text-muted">About Section</a></li>
...
<div class="container-fluid">
    <div class="row main">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('admin.about.update') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
